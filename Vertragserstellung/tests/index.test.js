...
test("Tests if all placeholders are replaced correctly", () => {
    ...
    expect(utils.replacePlaceHolders(text, placeholderValueMap)).toBe("Der Hahn mit Namen Rudolf schrie mit Lautstärke 12. Allerdings hatte Rudolf einen Brotkrumen im Hals und erstickte in Folge daran.")
})